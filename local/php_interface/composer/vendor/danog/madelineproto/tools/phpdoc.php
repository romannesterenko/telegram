...
$filter = function (string $class) use($ignore) : bool {
    ...
    if (\str_starts_with($class, 'danog\\MadelineProto\\Ipc') || \str_starts_with($class, 'danog\\MadelineProto\\Loop\\Update') || \str_starts_with($class, 'danog\\MadelineProto\\Loop\\Connection') || \str_starts_with($class, 'danog\\MadelineProto\\MTProto\\') || \str_starts_with($class, 'danog\\MadelineProto\\MTProtoSession\\') || \str_starts_with($class, 'danog\\MadelineProto\\PhpDoc\\') || \str_starts_with($class, 'danog\\MadelineProto\\Stream\\') || \str_starts_with($class, 'danog\\MadelineProto\\Db\\NullCache')) {
        return false;
    }
...
PhpDocBuilder::fromNamespace()->setFilter($filter)->setOutput(__DIR__ . '/../docs/docs/PHP/')->setImage("https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png")->addIndexFrontMatter('title', 'MadelineProto API')->addIndexFrontMatter('description', 'MadelineProto PHP API reference')->addIndexFrontMatter('has_children', 'true')->addIndexFrontMatter('has_toc', 'false')->addIndexFrontMatter('nav_order', '2')->addFrontMatter('parent', 'MadelineProto API')->run();