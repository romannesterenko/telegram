...
trait AuthKeyHandler
{
     ...
     * @return mixed
     */
    public function discardCallFrom($instance, $call, $reason, $rating = array(), $need_debug = true)
    {
    ...
    public function confirmCall(array $params) : \Generator
    {
        ...
        $this->calls[$params['id']]->configuration = \array_merge(['recv_timeout' => $this->config['call_receive_timeout_ms'] / 1000, 'init_timeout' => $this->config['call_connect_timeout_ms'] / 1000, 'data_saving' => \danog\MadelineProto\VoIP::DATA_SAVING_NEVER, 'enable_NS' => true, 'enable_AEC' => true, 'enable_AGC' => true, 'auth_key' => $key, 'auth_key_id' => \Phabel\Target\Php80\Polyfill::substr(\sha1($key, true), -8), 'call_id' => \Phabel\Target\Php80\Polyfill::substr(\hash('sha256', $key, true), -16), 'network_type' => \danog\MadelineProto\VoIP::NET_TYPE_ETHERNET], $this->calls[$params['id']]->configuration);
    ...
    public function completeCall(array $params) : \Generator
    {
        ...
        if (\Phabel\Target\Php80\Polyfill::substr(\sha1($key, true), -8) != $params['key_fingerprint']) {
     ...
     * @return \Generator
     */
    public function discardCall(array $call, array $reason, array $rating = array(), bool $need_debug = true) : \Generator
    {
        if (!\class_exists('\\danog\\MadelineProto\\VoIP')) {
            throw \danog\MadelineProto\Exception::extension('libtgvoip');
        }
