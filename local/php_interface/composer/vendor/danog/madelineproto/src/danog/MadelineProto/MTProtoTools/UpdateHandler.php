...
trait UpdateHandler
{
     ...
     */
    public function getUpdates($params = array()) : \Generator
    {
    ...
    public function saveUpdate(array $update) : \Generator
    {
        ...
        */
        ...
        } elseif (!isset($update['message']['from_id']) && isset($update['message']['peer_id']['user_id']) && $update['message']['peer_id']['user_id'] === $this->authorization['user']['id']) {
            $update['message']['out'] = true;
        }
