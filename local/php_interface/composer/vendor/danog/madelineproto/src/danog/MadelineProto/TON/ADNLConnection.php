...
class ADNLConnection
{
    ...
    public function connect(array $endpoint) : \Generator
    {
        ...
        $s1 = \Phabel\Target\Php80\Polyfill::substr($random, 0, 32);
        $s2 = \Phabel\Target\Php80\Polyfill::substr($random, 32, 32);
        $v1 = \Phabel\Target\Php80\Polyfill::substr($random, 64, 16);
        $v2 = \Phabel\Target\Php80\Polyfill::substr($random, 80, 16);
        ...
        $key = \Phabel\Target\Php80\Polyfill::substr($secret, 0, 16) . \Phabel\Target\Php80\Polyfill::substr($digest, 16, 16);
        $iv = \Phabel\Target\Php80\Polyfill::substr($digest, 0, 4) . \Phabel\Target\Php80\Polyfill::substr($secret, 20, 12);
