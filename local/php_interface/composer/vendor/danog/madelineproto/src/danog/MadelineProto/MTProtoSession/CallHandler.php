...
trait CallHandler
{
    ...
    public function methodRecall(string $watcherId, array $args) : void
    {
        ...
        $message_ids = ($this->outgoing_messages[$message_id] ?? null) instanceof Container ? $this->outgoing_messages[$message_id]->getIds() : [$message_id];
        foreach ($message_ids as $message_id) {
            if (isset($this->outgoing_messages[$message_id]) && !$this->outgoing_messages[$message_id]->canGarbageCollect()) {
                if ($datacenter) {
                    /** @var OutgoingMessage */
     ...
     * @return \Generator
     */
    public function methodCallAsyncRead(string $method, $args = array(), array $aargs = array('msg_id' => NULL)) : \Generator
    {
     ...
     * @return \Generator
     */
    public function methodCallAsyncWrite(string $method, $args = array(), array $aargs = array('msg_id' => NULL)) : \Generator
    {
        ...
        $message = new OutgoingMessage($args, $method, $methodInfo['type'], true, !$this->shared->hasTempAuthKey() && \strpos($method, '.') === false && $method !== 'ping_delay_disconnect');
     ...
     * @return \Generator
     */
    public function objectCall(string $object, $args = array(), array $aargs = array('msg_id' => NULL)) : \Generator
    {
        $message = new OutgoingMessage($args, $object, '', false, !$this->shared->hasTempAuthKey());
