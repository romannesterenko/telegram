...
trait ArrayCacheTrait
{
    ...
    {
        $this->cacheCleanupId = Loop::repeat(\max(1000, $this->cacheTtl * 1000 / 5), fn() => $this->cleanupCache());
    }
    /**
     *
     */
    ...
    private function cleanupCache() : void
    {
        ...
        Logger::log(\sprintf("cache for table: %s; keys left: %s; keys removed: %s", (string) $this, \count($this->cache), $oldCount), Logger::VERBOSE);
    }
}