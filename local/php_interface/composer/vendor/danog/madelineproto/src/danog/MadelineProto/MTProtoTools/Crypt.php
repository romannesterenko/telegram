...
abstract class Crypt
{
    ...
    {
        $x = $to_server ? 0 : 8;
        $sha256_a = \hash('sha256', $msg_key . \Phabel\Target\Php80\Polyfill::substr($auth_key, $x, 36), true);
        $sha256_b = \hash('sha256', \Phabel\Target\Php80\Polyfill::substr($auth_key, 40 + $x, 36) . $msg_key, true);
        $aes_key = \Phabel\Target\Php80\Polyfill::substr($sha256_a, 0, 8) . \Phabel\Target\Php80\Polyfill::substr($sha256_b, 8, 16) . \Phabel\Target\Php80\Polyfill::substr($sha256_a, 24, 8);
        $aes_iv = \Phabel\Target\Php80\Polyfill::substr($sha256_b, 0, 8) . \Phabel\Target\Php80\Polyfill::substr($sha256_a, 8, 16) . \Phabel\Target\Php80\Polyfill::substr($sha256_b, 24, 8);
    ...
    {
        $x = $to_server ? 0 : 8;
        $sha1_a = \sha1($msg_key . \Phabel\Target\Php80\Polyfill::substr($auth_key, $x, 32), true);
        $sha1_b = \sha1(\Phabel\Target\Php80\Polyfill::substr($auth_key, 32 + $x, 16) . $msg_key . \Phabel\Target\Php80\Polyfill::substr($auth_key, 48 + $x, 16), true);
        $sha1_c = \sha1(\Phabel\Target\Php80\Polyfill::substr($auth_key, 64 + $x, 32) . $msg_key, true);
        $sha1_d = \sha1($msg_key . \Phabel\Target\Php80\Polyfill::substr($auth_key, 96 + $x, 32), true);
        $aes_key = \Phabel\Target\Php80\Polyfill::substr($sha1_a, 0, 8) . \Phabel\Target\Php80\Polyfill::substr($sha1_b, 8, 12) . \Phabel\Target\Php80\Polyfill::substr($sha1_c, 4, 12);
        $aes_iv = \Phabel\Target\Php80\Polyfill::substr($sha1_a, 8, 12) . \Phabel\Target\Php80\Polyfill::substr($sha1_b, 0, 8) . \Phabel\Target\Php80\Polyfill::substr($sha1_c, 16, 4) . \Phabel\Target\Php80\Polyfill::substr($sha1_d, 0, 8);
        return [$aes_key, $aes_iv];
    }
    /**
     * CTR encrypt.
    ...
    {
        if (Magic::$hasOpenssl) {
            $iv_part_1 = \Phabel\Target\Php80\Polyfill::substr($iv, 0, 16);
            $iv_part_2 = \Phabel\Target\Php80\Polyfill::substr($iv, 16);
            $ciphertext = "";
