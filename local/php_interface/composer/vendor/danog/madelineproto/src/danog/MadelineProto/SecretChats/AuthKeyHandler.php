...
trait AuthKeyHandler
{
    ...
    public function acceptSecretChat($params) : \Generator
    {
        ...
        $key['fingerprint'] = \Phabel\Target\Php80\Polyfill::substr(\sha1($key['auth_key'], true), -8);
        $key['visualization_orig'] = \Phabel\Target\Php80\Polyfill::substr(\sha1($key['auth_key'], true), 16);
        $key['visualization_46'] = \Phabel\Target\Php80\Polyfill::substr(\hash('sha256', $key['auth_key'], true), 20);
