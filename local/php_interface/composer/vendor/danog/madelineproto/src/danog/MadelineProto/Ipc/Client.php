...
class Client extends ClientAbstract
{
    ...
    */
    ...
    {
        if (\is_array($args)) {
            if (($method === 'messages.editInlineBotMessage' || $method === 'messages.uploadMedia' || $method === 'messages.sendMedia' || $method === 'messages.editMessage') && isset($args['media']['file']) && $args['media']['file'] instanceof FileCallbackInterface) {
