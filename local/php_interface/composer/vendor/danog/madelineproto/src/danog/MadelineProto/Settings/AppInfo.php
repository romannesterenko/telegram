...
class AppInfo extends SettingsAbstract
{
    ...
    public function __construct()
    {
        ...
        if (isset($_SERVER['HTTP_ACCEPT_LANGUAGE'])) {
            $this->setLangCode(\Phabel\Target\Php80\Polyfill::substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2));
    ...
    {
        foreach (self::toCamel(['api_id', 'api_hash', 'device_model', 'system_version', 'app_version', 'lang_code', 'lang_pack']) as $object => $array) {
