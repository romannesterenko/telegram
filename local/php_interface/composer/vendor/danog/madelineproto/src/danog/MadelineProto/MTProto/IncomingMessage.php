...
class IncomingMessage extends Message
{
     ...
     * Response field map.
     */
    private const RESPONSE_ID_MAP = ['rpc_result' => 'req_msg_id', 'future_salts' => 'req_msg_id', 'msgs_state_info' => 'req_msg_id', 'bad_server_salt' => 'bad_msg_id', 'bad_msg_notification' => 'bad_msg_id', 'pong' => 'msg_id'];
    /**
     * State.
     */
    ...
    public function __construct(array $content, string $msgId, bool $fromContainer = false)
    {
        ...
        if (!$this->contentRelated) {
            $this->state |= 16;
            // message not requiring acknowledgment
        }
    }
    /**
