...
class SignalTest extends Fixtures
{
    ...
    public function testSignal(SignalInterface $loop) : \Generator
    {
        ...
        // Wait 0.5 seconds before returning null
        ...
        // Wait 0.1 seconds before returning null
        $loop->signal(true);
        // Move along loop to apply new interval
        (yield delay(110));
        $this->assertNull($loop->getPayload());
        // Result of sleep
    ...
    {
        return [[new class extends SignalLoop implements SignalInterface
        {
            use Signal;
