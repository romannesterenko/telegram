...
<div class="reports-result-list-wrap px-3">
<div class="report-table-wrap">
<div class="reports-list-left-corner"></div>
<div class="reports-list-right-corner"></div>
<table class="table table-stripped reports-list-table" id="report-result-table">
	<!-- head -->
	<tr>
	...
	<tr class="reports-list-item">
		...
		/*if ($col === 'ID' && !empty($arParams['DETAIL_URL']))
		{
            ...
            //$finalValue2 = htmlspecialchars_decode($finalValue);
            $finalValue2 = str_replace('&lt;button&gt;', '<button>', $row[$col]);
		?>
